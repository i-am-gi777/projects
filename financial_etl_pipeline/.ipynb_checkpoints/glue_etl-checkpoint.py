...
S3_BUCKET = "financial-ledger-bucket"
SALES_PATH = f"s3a://{S3_BUCKET}/raw/sales/"
TAX_PATH = f"s3a://{S3_BUCKET}/raw/tax/"
OUTPUT_PATH = f"s3a://{S3_BUCKET}/processed/consolidated/"
